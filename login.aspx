  ...
  <section id="registerform" class="registerform" style="padding-top:100px;background-color:antiquewhite">
     <div style="background-color:antiquewhite">
       ...
       <div style="min-width:40%;float:left;color:white;background-color:antiquewhite;height:550px;">
          <img src="img/logins.png" style="width:100%;height:550px;" />
      </div>
      ...
      <form runat="server" id="cardRegisterForm">
          ...
          <table class="nav-justified">
              ...
              <tr>
                  ...
                  <td>&nbsp;<asp:TextBox ID="PasswordTb" runat="server" TextMode="Password" style="border: 2px solid #73AD21;border-radius: 25px;width:200px;"></asp:TextBox></td>
                  <td>&nbsp;</td>
              </tr>
              <tr>
                  <td>&nbsp;</td>
              ...
              <tr>
                  ...
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button style="border-radius:25px;" CssClass="btn btn-success" ID="Button2" runat="server" Text="Login" OnClick="Button2_Click" OnClientClick="return Validator();" /></td>
                  <td>&nbsp;</td>
              </tr>
              <tr>
                  <td>&nbsp;</td>
          ...
          <div style="text-align:center;"">
               <a href="register.aspx" style="font-weight:bolder;font-size:20px;">Click here for new account</a>
          </div>
          <br />
          <br />
          <div style="text-align:center;"">
               <a href="fpassword.aspx" style="font-weight:bolder;font-size:20px;">Forgot Password</a>
          </div>
