    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse" style="background-color:#ccd9ff;">
        <ul class="nav navbar-nav">
          ...
          <li><a href="newappl.aspx">New Applications</a></li>
          ...
          <li><a href="fraudtrans.aspx">Fraud Transaction</a></li>
             ...
             <li class="active"><a href="message.aspx">View Messages</a></li>
  ...
  <section id="registerform" class="registerform" style="padding-top:100px;background-color:antiquewhite">
     <div style="background-color:antiquewhite">
       ...
       <div style="min-width:100%;float:left;color:white;background-color:antiquewhite;height:550px;">
         <h1 style="color:black;"><br /><br />Message</h1>
    ...
    OnPageIndexChanging="OnPageIndexChanging" PageSize="12" OnRowDeleting="GridView1_RowDeleting"  >
        <Columns>
            ...
            <asp:BoundField DataField="name" HeaderText="User Name" SortExpression="Named" />
            <asp:BoundField DataField="email" HeaderText="Email" SortExpression="Email" />
            <asp:BoundField DataField="subject" HeaderText="Subject" SortExpression="DOB" />
            <asp:BoundField DataField="message" HeaderText="Message" SortExpression="Age" />
             <asp:ButtonField ItemStyle-Width="150px" ButtonType="Button" CommandName="Reject" HeaderText="Delete" ShowHeader="True" Text="Delete"/>
            </Columns>
