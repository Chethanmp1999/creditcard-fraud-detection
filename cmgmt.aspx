<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cmgmt.aspx.cs" Inherits="index" %>
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse" style="background-color:#ccd9ff;">
        <ul class="nav navbar-nav">
         <li><a href="userhome.aspx">Home</a></li>
          ...
          <li class="active"><a href="cmgmt.aspx">Card Management</a></li>
...
<%--          <li class="dropdown">
  ...
  <section id="registerform" class="registerform" style="padding-top:100px;background-color:antiquewhite">
     <div style="background-color:antiquewhite">
       ...
       <div style="min-width:100%;float:left;color:white;background-color:antiquewhite;height:550px;"><br />
        <br /> <h1 style="color:black;">Your Cards</h1>
    ...
    OnPageIndexChanging="OnPageIndexChanging" PageSize="12" OnRowDeleting="GridView1_RowDeleting"  >
        <Columns>
            ...
            <asp:BoundField DataField="Cnum" HeaderText="Card #" SortExpression="Cnum" />

            <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Cardid" />
            <asp:BoundField DataField="Dob" HeaderText="DOB" SortExpression="Name" />
            <asp:BoundField DataField="Age" HeaderText="AGE" SortExpression="Ctype" />
            <asp:BoundField DataField="Uname" HeaderText="Uname #" SortExpression="Cnum" />
            <asp:BoundField DataField="Addr" HeaderText="Addr #" SortExpression="Cnum" />
             <asp:ButtonField ItemStyle-Width="150px" ButtonType="Button" CommandName="Reject" HeaderText="Delete" ShowHeader="True" Text="Un-Register"/>
            </Columns>
