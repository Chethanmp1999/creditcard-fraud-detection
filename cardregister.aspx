<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cardregister.aspx.cs" Inherits="index" %>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse" style="background-color:#ccd9ff;">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="cardregister.aspx">Card Register</a></li>
...
<%--          <li class="dropdown">
  ...
  <!-- Section: intro -->
  <section id="registerform" class="registerform" style="padding-top:100px;">
      <div style="min-width:20%;float:left;color:white;">.</div>
      <div style="min-width:60%;float:left;">      
      <form runat="server" id="cardRegisterForm">
          <h3>Register Your Card Here For Fraud Detection</h3>
          <table class="nav-justified">
             ...
             <tr>
              ...
              <tr>
                  <td>&nbsp;</td>
                  <td align="right">
                      <asp:Label ID="Label7" runat="server" Text="Credit Card Type : " style="font-weight:bolder;"></asp:Label>&nbsp;</td>
                  <td>&nbsp;
              ...
              <tr>
                  ...
                  <td>&nbsp;<asp:TextBox ID="TextBox4" runat="server" AutoPostBack="true" style="border: 2px solid #73AD21;border-radius: 25px;width:200px;" ReadOnly="true" OnTextChanged="TextBox4_TextChanged"></asp:TextBox></td>
                  <td>&nbsp;</td>
              </tr>
              <tr>
                  <td>&nbsp;</td>
              ...
              <tr>
                  <td>&nbsp;</td>
                  <td align="right">
                      <asp:Label ID="Label6" runat="server" Text="Confirm Credit Card # : " style="font-weight:bolder;"></asp:Label>&nbsp;</td>
                  <td>&nbsp;<asp:TextBox ID="TextBox5" runat="server" style="border: 2px solid #73AD21;border-radius: 25px;width:200px;" OnTextChanged="TextBox5_TextChanged" ReadOnly="true"></asp:TextBox></td>
                  <td>&nbsp;</td>
              </tr>
              <tr>
                  <td>&nbsp;</td>
              ...
              <tr>
                  <td>&nbsp;</td>
                  <td align="right">
                      <asp:Label ID="Label4" runat="server" Text="Address : " style="font-weight:bolder;"></asp:Label>&nbsp;</td>
                  <td>&nbsp;<asp:TextBox ID="TextBox3" runat="server" style="border: 2px solid #73AD21;border-radius: 25px;width:200px;" TextMode="MultiLine" Columns="150" Rows="3"></asp:TextBox></td>
                  <td>&nbsp;</td>
              </tr>
              <tr>
                  <td>&nbsp;</td>
  ...
  <script>
     function Validator() {
         ...
         var namer = document.getElementById('NameTB').value;
         ...
         var ccnum = document.getElementById('TextBox4').value;
         var intRegexage = /^[0-9]{16}$/;
         if (!intRegexage.test(ccnum)) {
         ...
         var cccnum = document.getElementById('TextBox5').value;
         var intRegexage = /^[0-9]{16}$/;
         if (!intRegexage.test(cccnum)) {
             alert('Please enter a valid card#.');
             flag = false;
             return flag;
         }
